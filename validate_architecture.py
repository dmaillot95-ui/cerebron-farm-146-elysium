...
NAME="ELYSIUM"
required=[
 ROOT/"architecture"/f"{NAME}_ARCHITECTURE_V1.json",
 ROOT/"memory"/f"{NAME}_MEMORY_CONTRACT_V1.json",
 ROOT/"benchmarks"/f"{NAME}_BENCHMARK_V1.json",
 ROOT/"config"/"model-candidates.json",
 ROOT/"training"/f"{NAME}_TRAINING_READINESS_GATES_V1.json",
]
